...
try {
    ...
    $preview = $repository->previewShippingExportForEvent($eventId);
    ...
    forge_staff_log_unexpected_exception($exception, $bootstrapPath, 'staff shipping export preview endpoint');
    forge_staff_send_fallback_response(
        500,
        [
            'application' => 'Forge',
