...
test('shared runtime source is authoritative for app and builder pricing', () => {
  ...
  assert.match(
    indexSource,
    /<script src="js\/forge-product-catalog\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-order-payload-builder\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-order-payload-preview\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-api-client\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-order-store\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-order-server-sync\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-sync-status\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-order-submission\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-event-state\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-staff-api-client\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-staff-catalog-ordering\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-catalog-image-viewer\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-staff-design-catalog-api\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-staff-design-catalog\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-staff-hat-catalog-api\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-staff-hat-catalog\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-staff-material-catalog-api\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-staff-material-catalog\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-staff-finished-hat-catalog-api\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-staff-finished-hat-catalog\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-staff-orders-runtime\.js\?v=20260728-39"><\/script>\s*<script src="js\/forge-local-orders-queue\.js\?v=20260728-39"><\/script>\s*<script src="js\/app\.js\?v=20260728-39"><\/script>/
  );
});
