...
assert_file_contains "${BUILD_DIR}/forge-deployment.manifest.txt" "private/forge_server/vendor/autoload.php"
assert_file_contains "${BUILD_DIR}/forge-deployment.manifest.txt" "private/forge_server/vendor/phpmailer/phpmailer/src/PHPMailer.php"
assert_file_contains "${BUILD_DIR}/forge-deployment.manifest.txt" "private/forge_server/cli/smoke-test-email.php"
assert_file_not_contains "${BUILD_DIR}/forge-deployment.manifest.txt" "public_html/forge/vendor/"
assert_file_not_contains "${BUILD_DIR}/forge-deployment.manifest.txt" "auth.json"
assert_file_not_contains "${BUILD_DIR}/forge-deployment.manifest.txt" "composer.phar"
