...
test('staff orders remains the default protected destination and the catalog shell is staff-only', () => {
  ...
  assert.match(
    indexSource,
    /<script src="js\/forge-staff-api-client\.js\?v=20260724-33"><\/script>\s*<script src="js\/forge-staff-catalog-ordering\.js\?v=20260724-33"><\/script>\s*<script src="js\/forge-catalog-image-viewer\.js\?v=20260724-33"><\/script>\s*<script src="js\/forge-staff-design-catalog-api\.js\?v=20260724-33"><\/script>\s*<script src="js\/forge-staff-design-catalog\.js\?v=20260724-33"><\/script>\s*<script src="js\/forge-staff-hat-catalog-api\.js\?v=20260724-33"><\/script>\s*<script src="js\/forge-staff-hat-catalog\.js\?v=20260724-33"><\/script>\s*<script src="js\/forge-staff-material-catalog-api\.js\?v=20260724-33"><\/script>\s*<script src="js\/forge-staff-material-catalog\.js\?v=20260724-33"><\/script>\s*<script src="js\/forge-staff-finished-hat-catalog-api\.js\?v=20260724-33"><\/script>\s*<script src="js\/forge-staff-finished-hat-catalog\.js\?v=20260724-33"><\/script>\s*<script src="js\/forge-staff-orders-runtime\.js\?v=20260724-33"><\/script>/
  );
